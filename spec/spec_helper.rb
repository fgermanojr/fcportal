...
# Comment. fgj. I am following the setup described in
# https://www.devmynd.com/blog/setting-up-rspec-and-capybara-in-rails-5-for-testing/

# Commnet. fgj. Added per https://github.com/colszowka/simplecov
require 'simplecov'
SimpleCov.start
...
# with RSpec, but feel free to customize to your heart's content.
  ...
  # !!! Identify tests that are slowing down your tests;
  # the additional output can be a bit noise
